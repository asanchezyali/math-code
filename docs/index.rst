...
| *Repository*: https://github.com/asanchezyali/math-code
...
.. toctree::
   ...
   notebooks/tutorial1/Lisa_Cluster
   notebooks/guide2/Research_Projects
   notebooks/guide3/Debugging_PyTorch
   notebooks/guide4/Research_Projects_with_JAX

.. toctree::
   :caption: Training Models at Scale
   :maxdepth: 2

   notebooks/scaling/JAX/overview
   notebooks/scaling/JAX/single_gpu_techniques
   notebooks/scaling/JAX/single_gpu_transformer
   notebooks/scaling/JAX/data_parallel_intro
   notebooks/scaling/JAX/data_parallel_fsdp
   notebooks/scaling/JAX/pipeline_parallel_simple
   notebooks/scaling/JAX/pipeline_parallel_looping
   notebooks/scaling/JAX/tensor_parallel_simple
   notebooks/scaling/JAX/tensor_parallel_async
   notebooks/scaling/JAX/tensor_parallel_transformer
   notebooks/scaling/JAX/3d_parallelism

.. toctree::
   :caption: Deep Learning 1 (PyTorch)
   :maxdepth: 2

   notebooks/tutorial2/Introduction_to_PyTorch
   notebooks/tutorial3/Activation_Functions
   notebooks/tutorial4/Optimization_and_Initialization
   notebooks/tutorial5/Inception_ResNet_DenseNet
   notebooks/tutorial6/Transformers_and_MHAttention
   notebooks/tutorial7/GNN_overview
   notebooks/tutorial8/Deep_Energy_Models
   notebooks/tutorial9/AE_CIFAR10
   notebooks/tutorial10/Adversarial_Attacks
   notebooks/tutorial11/NF_image_modeling
   notebooks/tutorial12/Autoregressive_Image_Modeling
   notebooks/tutorial15/Vision_Transformer
   notebooks/tutorial16/Meta_Learning
   notebooks/tutorial17/SimCLR

.. toctree::
   :caption: Deep Learning 1 (JAX+Flax)
   :maxdepth: 2

   notebooks/JAX/tutorial2/Introduction_to_JAX
   notebooks/JAX/tutorial3/Activation_Functions
   notebooks/JAX/tutorial4/Optimization_and_Initialization
   notebooks/JAX/tutorial5/Inception_ResNet_DenseNet
   notebooks/JAX/tutorial6/Transformers_and_MHAttention
   notebooks/JAX/tutorial7/GNN_overview
   notebooks/JAX/tutorial9/AE_CIFAR10
   notebooks/JAX/tutorial11/NF_image_modeling
   notebooks/JAX/tutorial12/Autoregressive_Image_Modeling
   notebooks/JAX/tutorial15/Vision_Transformer
   notebooks/JAX/tutorial17/SimCLR

.. toctree::
   :caption: Deep Learning 2
   :maxdepth: 2

   notebooks/DL2/Geometric_deep_learning/tutorial1_regular_group_convolutions
   notebooks/DL2/Geometric_deep_learning/tutorial2_steerable_cnns
   notebooks/DL2/deep_probabilistic_models_I/tutorial_1.ipynb
   notebooks/DL2/deep_probabilistic_models_II/tutorial_2a.ipynb
   notebooks/DL2/deep_probabilistic_models_II/tutorial_2b.ipynb
   notebooks/DL2/Advanced_Generative_Models/Normalizing_flows/advancednormflow.ipynb
   notebooks/DL2/High-performant_DL/hyperparameter_search/hpdlhyperparam.ipynb
   notebooks/DL2/High-performant_DL/Multi_GPU/hpdlmultigpu.ipynb
   notebooks/DL2/Bayesian_Neural_Networks/dl2_bnn_tut1_students_with_answers.ipynb
   notebooks/DL2/Bayesian_Neural_Networks/dl2_bnn_tut2_student_with_answers.ipynb
   notebooks/DL2/Dynamical_Neural_Networks/Complete_DNN_2_1.ipynb
   notebooks/DL2/Dynamical_Neural_Networks/Complete_DNN_2_2.ipynb
   notebooks/DL2/Dynamical_systems/dynamical_systems_neural_odes.ipynb
   notebooks/DL2/sampling/introduction.ipynb
   notebooks/DL2/sampling/subsets.ipynb
   notebooks/DL2/sampling/permutations.ipynb
   notebooks/DL2/sampling/graphs.ipynb
   notebooks/DL2/Causality_and_CRL/citris-tutorial.ipynb
